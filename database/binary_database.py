...
class BinaryDatabase:
    ...
    def __init__(self, metadb_path=None, tags=None):
        ...
        self.metadb_path = metadb_path if metadb_path else cfg.BINARY_DATABASE
...
if __name__ == '__main__':
    sha256 = '1b517d81fddc513ffefb2c78997d8ba58204fe021acce1b940464f65f468e065'
    database = BinaryDatabase()
    file = database.get_file(sha256)
    pprint(file)
